%% Main File - Baseline Controller for Large House [HEMS]

% Author: Ninad Kiran Gaikwad
% Date: Feb/1/2021
% Description: Main File for Baseline Controller for Large Hous
...
N_None=0;       % Houses with niether PV and Battery
...
SimulationPerformanceData_FileName='PerformanceData_Gainesville_Baseline_7DayTest_SC_PVBat1_Bat0_PV0_None0_SLC1';

LoadData_FileName='PecanStreet_LoadData_SC_PVBat1_Bat0_PV0_None0';
...
LoadData_k_Plant.E_Load_Desired=E_Load_Desired(1,:); % total load for each house initially
LoadData_k_Plant.E_LoadData=E_LoadData(1,:,:);

% W_k_Plant   % includes both Weather data and Load data
W_k_Plant=[];
