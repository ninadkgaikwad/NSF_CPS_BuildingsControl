function [HEMSPlant_Params,HEMSHouse_Params] = HEMS_CommunityHouse_Parameter_Generator1(Community_Params,Simulation_Params)
% edited by shishir
...
MaxRate_Discharging=5*N1;
MaxRate_Discharging_StartUp=7*N1;

Battery_Energy_Max = 13.5*N1; % 13.5
%Battery_Energy_Max = 1000*N1; % 13.5
